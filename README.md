# Pandas Homework - Pandas, Pandas, Pandasl
...
3. Inside your local git repository, create a directory for the Pandas Challenge you choose. Use folder names corresponding to the challenges: *** or  **PyCitySchools**.
